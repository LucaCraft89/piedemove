...
const _dark = MapPalette(
  ...
  building: '#22262c',
  buildingLine: '#2b3037',
  motorway: RoadStyle('#5b6472', '#0d0f12', 2.5, 5, 14),
  primary: RoadStyle('#4d5563', '#0d0f12', 1.6, 4, 12),
  secondary: RoadStyle('#434a57', '#0d0f12', 1.2, 3.2, 10),
  tertiary: RoadStyle('#3a404b', '#0d0f12', 0.8, 2.6, 8),
  minor: RoadStyle('#30353e', '#15181c', 0.4, 1.8, 6),
  path: '#3a404b',
  rail: '#454c58',
  text: '#c9ced6',
  halo: '#181b20',
...
const _colour = MapPalette(
  ...
  building: '#e4dccb',
  buildingLine: '#d6cdb9',
  motorway: RoadStyle('#f0955e', '#b5623a', 2.5, 5, 14),
  primary: RoadStyle('#f6c25c', '#c39432', 1.6, 4, 12),
  secondary: RoadStyle('#fbe28a', '#cdb055', 1.2, 3.2, 10),
